   ...
   <body>
         ...
         <div class="row">
            <div class="col-md-4">
               <figure class="card card-product">
                  <div class="img-wrap"><img src="https://w3adda.com/wp-content/uploads/2019/07/51TdkJSqeQL._AC_UL436_.jpg"></div>
            ...
            <div class="col-md-4">
               <figure class="card card-product">
                  <div class="img-wrap"><img src="https://w3adda.com/wp-content/uploads/2019/07/61TMYERLL._AC_UL436_.jpg"> </div>
                  <figcaption class="info-wrap">
            ...
            <div class="col-md-4">
               <figure class="card card-product">
                  <div class="img-wrap"><img src="https://w3adda.com/wp-content/uploads/2019/07/31vga2yygfL._AC_US160_.jpg"> </div>
                  <figcaption class="info-wrap">
      ...
      <script>
         ...
         $('body').on('click', '.buy_now', function(e){
           ...
           var action_url =  "{{ route('payment_success') }}";
           ...
           var options = {
           "key": "{{ env('RAZOR_KEY') }}", //RAZOR_KEY
           "amount": (totalAmount*100), // 2000 paise = INR 20
           "name": "W3Adda",
           "description": "Payment",
           "image": "https://w3adda.com/wp-content/uploads/2019/07/w3a-fb-dp.png",
